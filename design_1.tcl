...
proc create_root_design { parentCell } {
  ...
  # Create instance: divide6_0, and set properties
  set divide6_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:divide6:1.0 divide6_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins divide6_0/in_r]
